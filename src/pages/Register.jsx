...
/*
  ...
  REGISTER PAGE
  ─────────────────────────────────────────────
  Handles user account creation using Firebase Auth.
...
export default function Register() {
  ...
  /*
    ...
    3. Checks password strength requirement
    4. Creates Firebase user account
    5. Handles success and error cases
  */
  async function handleRegister(e) {
    ...
    // Basic password rule (Firebase minimum is 6 chars)
    ...
    try {
      ...
      // Handle known Firebase error cases
      ...
      <main className="auth-main">
        <div className="auth-card">
          ...
          <form className="ev-form" onSubmit={handleRegister}>
            ...
            {/* Email input */}
            <div>
              <label className="ev-label" htmlFor="reg-email">
                Email
              </label>
            ...
            {/* Password input */}
            <div>
              <label className="ev-label" htmlFor="reg-password">
                Password
              </label>
            ...
            <div>
              <label className="ev-label" htmlFor="reg-confirm">
                Confirm password
              </label>
